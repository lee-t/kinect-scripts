## as of 3/30/17 this script works on RPi 3 version B- Tested on long_term_recording
## 5/30/17 added picam recording AFTER background calibration & added 
## timestamps to recording and background gen
...
dtstamp = datetime.datetime.now().strftime(" %m-%d-%Y %H:%M:%S ")
print "start picam recording"
camtime= time.time()
logging.info('[INFO] Pi Recording starting at:' + dtstamp)

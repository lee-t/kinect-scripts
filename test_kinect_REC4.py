...
def get_depth_array32():
	...
	c = (array >> 8) & 0xff
	f = array & 0xff
	zeros = np.zeros((640, 480), dtype="uint8")
	arrayn = np.asarray([c.T, f.T, zeros.T])
...
out_d = cv2.VideoWriter('/media/pi/WDpassport/Kinect/10m_4fdepth4.h264',fourcc,4.0,(640,480))    
out_RGB = cv2.VideoWriter('/media/pi/WDpassport/Kinect/10m_4fRGB4.h264',fourcc,4.0,(640,480))    
